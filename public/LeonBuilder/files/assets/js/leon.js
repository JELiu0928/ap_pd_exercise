...
$(document).ready(function() {
	...
	//日期初始化
	$("body").append('<div id="Leon_DateTimePicker">Hello</div>');
	$("#Leon_DateTimePicker").DateTimePicker({
		monthYearSeparator: "-",
		language:"zh-TW"
	});	
	//選單初始化
	$('.select2').select2();
	//拖曳
	var Sortable_el = $('.sortable');
	$(Sortable_el).each(function (i,e) {
		Sortable.create(e, {
			animation: 150,
